package com.codepath.cchem.gram.ui.camera;
...
import com.codepath.cchem.gram.ui.home.StoriesFragment;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        btnCaptureImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getContext(), "yeppppp", Toast.LENGTH_SHORT).show();
                launchCamera();
            }
        });
...
//                    Navigation.findNavController(view).navigate(R.id.action_camera_fragment_to_stories_fragment);
